...
import 'package:movieapp/controllers/main_page_data_controller.dart';
import 'package:movieapp/model/main_page_data.dart';
import 'package:movieapp/model/movie.dart';
import 'package:movieapp/model/search_category.dart';
import 'package:movieapp/widgets/movie_tile.dart';
 ...
 late var  _selectedMoviePosterURL;
  ...
  Widget _bgImage(){
   ...
   Widget _foregroundWidgets() {
    return Container(
      padding: EdgeInsets.fromLTRB(0, _dheight! * 0.02, 0, 0),
      width: _dwidth! * 0.90,
      child: Column(
        ...
        children: [
          _topBarWidget(),
          Container(
            height: _dheight! * 0.83,
            padding: EdgeInsets.symmetric(vertical: _dheight! * 0.01),
          ...
          itemBuilder: (BuildContext _context, int _count) {
            return Padding(
              padding: EdgeInsets.symmetric(
                  vertical: _dheight! * 0.01, horizontal: 0),
